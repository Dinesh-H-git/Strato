...
const Subtitle = {
  Display: {
    Level1: {
      ...
      Family: "var(--dt-typography-subtitle-display-level-1-family, DynatraceFlow,Roboto,Helvetica,sans-serif)",
      /** Css custom property: --dt-typography-subtitle-display-level-1-weight. Default value: 400. */
      Weight: "var(--dt-typography-subtitle-display-level-1-weight, 400)",
      /** Css custom property: --dt-typography-subtitle-display-level-1-size. Default value: 28px. */
      Size: "var(--dt-typography-subtitle-display-level-1-size, 28px)",
      /** Css custom property: --dt-typography-subtitle-display-level-1-line-height. Default value: 1.4285714286. */
      LineHeight: "var(--dt-typography-subtitle-display-level-1-line-height, 1.4285714286)",
      /** Css custom property: --dt-typography-subtitle-display-level-1-text-decoration. Default value: none. */
      TextDecoration: "var(--dt-typography-subtitle-display-level-1-text-decoration, none)",
      /** Css custom property: --dt-typography-subtitle-display-level-1-text-transform. Default value: none. */
      TextTransform: "var(--dt-typography-subtitle-display-level-1-text-transform, none)"
    },
    Level2: {
      ...
      Family: "var(--dt-typography-subtitle-display-level-2-family, DynatraceFlow,Roboto,Helvetica,sans-serif)",
      /** Css custom property: --dt-typography-subtitle-display-level-2-weight. Default value: 400. */
      Weight: "var(--dt-typography-subtitle-display-level-2-weight, 400)",
      /** Css custom property: --dt-typography-subtitle-display-level-2-size. Default value: 24px. */
      Size: "var(--dt-typography-subtitle-display-level-2-size, 24px)",
      /** Css custom property: --dt-typography-subtitle-display-level-2-line-height. Default value: 1.5. */
      LineHeight: "var(--dt-typography-subtitle-display-level-2-line-height, 1.5)",
      /** Css custom property: --dt-typography-subtitle-display-level-2-text-decoration. Default value: none. */
      TextDecoration: "var(--dt-typography-subtitle-display-level-2-text-decoration, none)",
      /** Css custom property: --dt-typography-subtitle-display-level-2-text-transform. Default value: none. */
      TextTransform: "var(--dt-typography-subtitle-display-level-2-text-transform, none)"
    },
    Level3: {
      ...
      Family: "var(--dt-typography-subtitle-display-level-3-family, DynatraceFlow,Roboto,Helvetica,sans-serif)",
      /** Css custom property: --dt-typography-subtitle-display-level-3-weight. Default value: 400. */
      Weight: "var(--dt-typography-subtitle-display-level-3-weight, 400)",
      /** Css custom property: --dt-typography-subtitle-display-level-3-size. Default value: 21px. */
      Size: "var(--dt-typography-subtitle-display-level-3-size, 21px)",
      /** Css custom property: --dt-typography-subtitle-display-level-3-line-height. Default value: 1.5238095238. */
      LineHeight: "var(--dt-typography-subtitle-display-level-3-line-height, 1.5238095238)",
      /** Css custom property: --dt-typography-subtitle-display-level-3-text-decoration. Default value: none. */
      TextDecoration: "var(--dt-typography-subtitle-display-level-3-text-decoration, none)",
      /** Css custom property: --dt-typography-subtitle-display-level-3-text-transform. Default value: none. */
      TextTransform: "var(--dt-typography-subtitle-display-level-3-text-transform, none)"
    }
  },
  Heading: {
    Level1: {
      ...
      Family: "var(--dt-typography-subtitle-heading-level-1-family, DynatraceFlow,Roboto,Helvetica,sans-serif)",
      /** Css custom property: --dt-typography-subtitle-heading-level-1-weight. Default value: 400. */
      Weight: "var(--dt-typography-subtitle-heading-level-1-weight, 400)",
      /** Css custom property: --dt-typography-subtitle-heading-level-1-size. Default value: 21px. */
      Size: "var(--dt-typography-subtitle-heading-level-1-size, 21px)",
      /** Css custom property: --dt-typography-subtitle-heading-level-1-line-height. Default value: 1.5238095238. */
      LineHeight: "var(--dt-typography-subtitle-heading-level-1-line-height, 1.5238095238)",
      /** Css custom property: --dt-typography-subtitle-heading-level-1-text-decoration. Default value: none. */
      TextDecoration: "var(--dt-typography-subtitle-heading-level-1-text-decoration, none)",
      /** Css custom property: --dt-typography-subtitle-heading-level-1-text-transform. Default value: none. */
      TextTransform: "var(--dt-typography-subtitle-heading-level-1-text-transform, none)"
    },
    Level2: {
      ...
      Family: "var(--dt-typography-subtitle-heading-level-2-family, DynatraceFlow,Roboto,Helvetica,sans-serif)",
      /** Css custom property: --dt-typography-subtitle-heading-level-2-weight. Default value: 400. */
      Weight: "var(--dt-typography-subtitle-heading-level-2-weight, 400)",
      /** Css custom property: --dt-typography-subtitle-heading-level-2-size. Default value: 18px. */
      Size: "var(--dt-typography-subtitle-heading-level-2-size, 18px)",
      /** Css custom property: --dt-typography-subtitle-heading-level-2-line-height. Default value: 1.5555555556. */
      LineHeight: "var(--dt-typography-subtitle-heading-level-2-line-height, 1.5555555556)",
      /** Css custom property: --dt-typography-subtitle-heading-level-2-text-decoration. Default value: none. */
      TextDecoration: "var(--dt-typography-subtitle-heading-level-2-text-decoration, none)",
      /** Css custom property: --dt-typography-subtitle-heading-level-2-text-transform. Default value: none. */
      TextTransform: "var(--dt-typography-subtitle-heading-level-2-text-transform, none)"
    },
    Level3: {
      ...
      Family: "var(--dt-typography-subtitle-heading-level-3-family, DynatraceFlow,Roboto,Helvetica,sans-serif)",
      /** Css custom property: --dt-typography-subtitle-heading-level-3-weight. Default value: 400. */
      Weight: "var(--dt-typography-subtitle-heading-level-3-weight, 400)",
      /** Css custom property: --dt-typography-subtitle-heading-level-3-size. Default value: 16px. */
      Size: "var(--dt-typography-subtitle-heading-level-3-size, 16px)",
      /** Css custom property: --dt-typography-subtitle-heading-level-3-line-height. Default value: 1.5. */
      LineHeight: "var(--dt-typography-subtitle-heading-level-3-line-height, 1.5)",
      /** Css custom property: --dt-typography-subtitle-heading-level-3-text-decoration. Default value: none. */
      TextDecoration: "var(--dt-typography-subtitle-heading-level-3-text-decoration, none)",
      /** Css custom property: --dt-typography-subtitle-heading-level-3-text-transform. Default value: none. */
      TextTransform: "var(--dt-typography-subtitle-heading-level-3-text-transform, none)"
    }
  }
};
const Text = {
