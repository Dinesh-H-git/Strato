...
const DynatraceIconComponent = /* @__PURE__ */ forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsxs(SvgIcon, { "data-iconname": "DynatraceIcon", ref: forwardedRef, ...props, children: [
    /* @__PURE__ */ jsx("path", { d: "m4.485 16.872.766-1.989h.314L4.366 18H4.053l.275-.718-.918-2.399h.315z" }),
    /* @__PURE__ */ jsx("path", { d: "M10.376 14.888h.633v.271h-.633v1.475q0 .206.09.29.086.086.3.086v.005h.505v.271h-.547c-.181 0-.428-.038-.557-.243a.73.73 0 0 1-.096-.39V14.17h.305z" }),
    /* @__PURE__ */ jsx("path", { d: "M6.66 14.888c.361.005.585.114.723.252.218.213.219.521.219.557 0 .038 0 1.46-.005 1.585h-.3v-1.594a.52.52 0 0 0-.147-.366c-.09-.09-.271-.158-.51-.162-.237 0-.413.071-.508.162a.52.52 0 0 0-.148.366v1.594h-.3v-1.585c0-.036.001-.344.22-.557.137-.133.362-.247.723-.252z" }),
    ...
    /* @__PURE__ */ jsx("path", { d: "M12.707 15.155h-.504q-.215 0-.3.086-.091.087-.09.295v1.74h-.304v-1.764a.73.73 0 0 1 .095-.39c.128-.205.375-.244.556-.244h.547z" }),
    ...
    /* @__PURE__ */ jsx("path", { d: "M16.666 15.155h-.729c-.247 0-.403.072-.498.167a.55.55 0 0 0-.153.356v.79a.5.5 0 0 0 .152.366C15.535 16.93 15.69 17 15.939 17h.728v.272h-.694c-.386 0-.62-.114-.762-.252-.224-.214-.224-.523-.224-.557v-.77c0-.034 0-.343.224-.557.143-.138.376-.253.762-.253h.694z" }),
    ...
    /* @__PURE__ */ jsx("path", { d: "M5.053 5.884c.164-.677 2.973-.339 2.973-.339C7.877 7.327 7.968 8.53 7.97 8.556L5.434 10.97a41 41 0 0 1-.296-2.88 39 39 0 0 1-.085-2.206" }),
    /* @__PURE__ */ jsx("path", { d: "M8.972 2.002a40 40 0 0 1 2.357.207 47 47 0 0 1 2.852.433l-2.536 2.414s-1.196-.15-3.007-.094a28 28 0 0 0-2.724.23c-.136.02-.476.09-.683.353a.8.8 0 0 0-.178.34V5.728c0-.033-.024-.386.296-.696.729-.697 2.545-2.419 2.908-2.762.329-.315.68-.269.715-.269" })
  ] });
});
const DynatraceIcon = /* @__PURE__ */ Object.assign(
  DynatraceIconComponent,
  { displayName: "DynatraceIcon" }
);
export {
  DynatraceIcon
};
//# sourceMappingURL=DynatraceIcon.js.map
