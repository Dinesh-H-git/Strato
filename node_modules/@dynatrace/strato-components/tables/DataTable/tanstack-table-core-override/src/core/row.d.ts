 ...
 */
export declare function getRowProto<TData extends RowData>(table: Table<TData>): CoreRow<TData>;
export declare const createRow: <TData extends RowData>(table: Table<TData>, id: string, original: TData, rowIndex: number, depth: number, subRows?: Row<TData>[], parentId?: string) => Row<TData>;
