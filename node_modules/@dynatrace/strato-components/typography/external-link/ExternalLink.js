...
var styles = __toESM(require("./ExternalLink.sty.js"));
...
const COMPONENT_NAME = "ExternalLink";
const ExternalLink = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "a",
    {
      ...
      className: (0, import_clsx.default)(styles.externalLink, consumerClassName),
      style: consumerStyle,
      "data-testid": dataTestId,
      "data-dtrum-mask": dataDtrumMask,
      "data-dtrum-allow": dataDtrumAllow,
      ...
      children: [
        children,
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { userSelect: "none" }, children: [
          "\uFEFF",
...
ExternalLink.displayName = COMPONENT_NAME;
