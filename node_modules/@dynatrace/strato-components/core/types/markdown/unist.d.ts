/**
 * Copy from {@link https://www.npmjs.com/package/@types/unist} to not expose a third party type on our API.
 * @public
 */
/**
 ...
 * @public
 */
export interface Parent<ChildNode extends Node<object> = Node, TData extends object = NodeData<ChildNode>> extends Node<TData> {
    /**
