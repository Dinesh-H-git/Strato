 ...
 */
export declare enum GetAllActiveGatesQueryEnabledModuleItem {
    Aws = "AWS",
    Azure = "AZURE",
    ...
    Logs = "LOGS",
    MemoryDumps = "MEMORY_DUMPS",
    MetricApi = "METRIC_API",
    OneAgentRouting = "ONE_AGENT_ROUTING",
    OtlpIngest = "OTLP_INGEST",
    RestApi = "REST_API",
    Synthetic = "SYNTHETIC",
    Vmware = "VMWARE",
    ZOs = "Z_OS"
