...
export declare class MonitoredEntitiesCustomTagsClient {
    ...
    deleteTags(config: {
         ...
         */ to?: string;
        abortSignal?: AbortSignal;
    }): Promise<DeletedEntityTags>;
}
export declare const monitoredEntitiesCustomTagsClient: MonitoredEntitiesCustomTagsClient;
