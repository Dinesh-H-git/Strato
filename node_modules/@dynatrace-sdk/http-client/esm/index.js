...
function addHttpClientResponseErrorSerializer() {
  if (!errorSerializerAdded && isGlobalErrorSerializerSupported()) {
    ...
    addGlobalErrorSerializer(httpClientResponseErrorSerializer);
  }
}
...
export {
  ...
  AbortSignal as PlatformAbortSignal,
  BaseError as PlatformBaseError,
  Binary as PlatformBinary,
  DataTypeError as PlatformDataTypeError,
  HttpClient as PlatformHttpClient,
  HttpClientAbortError as PlatformHttpClientAbortError,
  HttpClientRequestError as PlatformHttpClientRequestError,
  HttpClientResponse as PlatformHttpClientResponse,
  HttpClientResponseError as PlatformHttpClientResponseError,
  UnsupportedOperationError as PlatformUnsupportedOperationError,
  OAuthHttpClient as _OAuthHttpClient,
  httpClient,
