...
export interface NewInclude {
    ...
    dataObject: string;
    /**
     * Data will be filtered by this value. Field names must only contain letters, numbers and underscores, otherwise they need to be escaped using quotes(`).
     */
    filter: string;
    /**
